...
final class JobDefinitionsContainerTest extends TestCase
{
    ...
    public function testGetJobDefinition(): void
    {
        ...
        $failResolveStrategy = new ConstantDelayInSecondsFailResolveStrategy(10);
        ...
        $jobDefinitionsConfig = [
            self::SIMPLE_JOB_NAME => [
                ...
                JobDefinitionFactoryInterface::JOB_FAIL_RESOLVE_STRATEGY => $failResolveStrategy,
            ],
        ];
        ...
        Assert::assertSame($failResolveStrategy, $simpleJobDefinition->getFailResolveStrategy());
    }
